...
namespace GL
{
	...
	void GLRenderer::SetupViewport(int width, int height)
	{
		...
		*m_CurrentMatrix = Math::Ortho(0.0f, m_RenderData.Width, m_RenderData.Height, 0.0f, -1.0f, 1.0f);
	...
	void GLRenderer::ClearColorBuffer(Graphics::Color color)
	{
		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
		auto colorV = Graphics::ColorToVec4(color);
